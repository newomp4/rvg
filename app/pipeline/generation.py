...
_STORY_RULES = (
    ...
    "\n"
    "CAPTION COLOR TAGS — IMPORTANT:\n"
    "Wrap key emotional or dramatic words/phrases in inline color tags so "
    "the on-screen captions pop. Use them on roughly 8 to 15 short phrases "
    "across the story (single words or 2-3 word phrases). Available tags:\n"
    "  {red}...{/red}      injuries, fights, blood, anger, danger\n"
    "  {green}...{/green}  vomit, sickness, money, gross-but-funny\n"
    "  {blue}...{/blue}    sad, cold, calm, water, tears\n"
    "  {yellow}...{/yellow} warning, surprise, money/gold\n"
    "  {orange}...{/orange} fire, embarrassment, energy\n"
    "  {purple}...{/purple} weird, mystery, royalty\n"
    "  {pink}...{/pink}    love, romance, awkward, cringe\n"
    "Example: \"He {red}slapped me{/red} so hard I {orange}saw stars{/orange} "
    "and {green}threw up{/green} on his shoes.\"\n"
    "Tags must perfectly nest (open then close) and only wrap real "
    "story words — never tag punctuation alone."
)
